 ...
 */
public class AddNewSurgeryWindow_EN extends javax.swing.JFrame {

    /**
     * Creates new form AddNewPathologyWindow_EN
     */
    public AddNewSurgeryWindow_EN() {
        initComponents();
    }
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        if (new SurgeriesList().checkIfSurgeryExists(srg)) {
            JOptionPane.showMessageDialog(this, "This surgery name already exists. Try updating it.\n",
                    "Error ",
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        int option = JOptionPane.showOptionDialog(this, "The datas you introduced are:\n"
                ...
                + "\n\nDo you want to add them or go back and update them?",
                "Check info",
        ...
        if (option == 0) {
            //save data
            SurgeriesListPanel_EN.addNewSurgeryEntry(srg, ptg, avg, std);
        }
