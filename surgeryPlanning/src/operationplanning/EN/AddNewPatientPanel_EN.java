 ...
 * @author diana
 */
public class AddNewPatientPanel_EN extends javax.swing.JPanel {

    /**
     * Creates new form addNewPatientPannel_EN
     */
    public AddNewPatientPanel_EN() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        savePatientInfoButton.setText("Add patient info");
    ...
    private void savePatientInfoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savePatientInfoButtonActionPerformed
        ...
        if(!result){
            ...
            Object[] obj={"Ok"};
            JOptionPane.showOptionDialog(null, "There is a patient with these details.\n"
                    + "Patient ID is: " + existingPatientId.replace("P", ""), 
