 ...
 * @author diana
 */
public class CurrentUserPanel_EN extends javax.swing.JPanel {

    /**
     * Creates new form UserPanel_EN
     * @param userType
     */
    public CurrentUserPanel_EN() {

        initComponents();
        
        userNameTextField.setText(Planning_EN.currentUserName);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("(*) Mandatory only for current user");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(repeatPasswordField, javax.swing.GroupLayout.DEFAULT_SIZE, 380, Short.MAX_VALUE)
    ...
    private void resetPasswordButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_resetPasswordButtonActionPerformed
        ...
        if("".equals(userNameTextField.getText()) 
            ...
            JOptionPane.showConfirmDialog(null, "One or more fields are empty."
                    + "\nChanging password aborted.", "Error. Empty fields", JOptionPane.DEFAULT_OPTION);
            return;
        }
        if(userNameTextField.getText().equals(Planning_EN.currentUserName) &&
        ...
        if (userNameTextField.getText().equals(Planning_EN.currentUserType) && !userInst.checkUserCredentials(userNameTextField.getText(), currentPassword)) {
            JOptionPane.showConfirmDialog(null, "Username and current password don't match."
                    + "\nChanging password aborted.", "Error matching username and password", JOptionPane.DEFAULT_OPTION);
            return;
        }
        if (!newPassword.equals(repeatPassword)) {
            JOptionPane.showConfirmDialog(null, "The new password is not the same in both fields."
                    + "\nChanging password aborted.", "Password doesn't match", JOptionPane.DEFAULT_OPTION);
            return;
        }

        int ans = JOptionPane.showOptionDialog(null, new JLabel("<html>Are you sure you want to change the password\n"
                + "for user <b>" + userNameTextField.getText() + "</b>?</html>"),
                "Changing password confirmation",
                JOptionPane.OK_CANCEL_OPTION,
                JOptionPane.QUESTION_MESSAGE,
                null, null, JOptionPane.OK_OPTION);
        if (ans == JOptionPane.OK_OPTION) {
            userInst.changePasswordForUser(userNameTextField.getText(), newPassword);
            JOptionPane.showConfirmDialog(null, "Password has been changed successfully.",
