 ...
 */
public class UpdatePatientPanel_EN extends javax.swing.JPanel {

    /**
     * Creates new form AddNewPatientPanelES
     */
    public UpdatePatientPanel_EN() {
        initComponents();
    ...
    private void initComponents() {
        ...
        addUpdateButtonGroup = new javax.swing.ButtonGroup();
        ...
        medicalTeamLabel.setMaximumSize(new java.awt.Dimension(115, 30));
        medicalTeamLabel.setMinimumSize(new java.awt.Dimension(115, 30));
        medicalTeamLabel.setPreferredSize(new java.awt.Dimension(115, 30));

        medicLabel.setText("Medic");
        medicLabel.setMaximumSize(new java.awt.Dimension(115, 30));
        medicLabel.setMinimumSize(new java.awt.Dimension(115, 30));
        medicLabel.setPreferredSize(new java.awt.Dimension(115, 30));
        ...
        surgeryLabel.setMaximumSize(new java.awt.Dimension(115, 30));
        surgeryLabel.setMinimumSize(new java.awt.Dimension(115, 30));
        surgeryLabel.setPreferredSize(new java.awt.Dimension(115, 30));

        patologyLabel.setText("Pathology");
        patologyLabel.setMaximumSize(new java.awt.Dimension(115, 30));
        patologyLabel.setMinimumSize(new java.awt.Dimension(115, 30));
        patologyLabel.setPreferredSize(new java.awt.Dimension(115, 30));
        ...
        addUpdateButtonGroup.add(addSurgeryRadioButton);
        addSurgeryRadioButton.setSelected(true);
        addSurgeryRadioButton.setText("Add a new surgery for patient");
        ...
        addUpdateButtonGroup.add(updateSurgeryRadioButton);
        updateSurgeryRadioButton.setText("Update existing surgery for patient");
        ...
        scheduledCheckBox.setText("Scheduled");
        ...
        saveButton.setText("Save surgery");
        ...
        deleteSurgeryButton.setText("Delete surgery");
        ...
        savePatientInfoButton.setText("Update patient info");
        ...
        observationsLabel.setText("Remarks");
        ...
        layout.setHorizontalGroup(
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(surgeryLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(medicLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(searchIDButton, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(searchByNameAndBirthdateButton, javax.swing.GroupLayout.Alignment.TRAILING))
                .addContainerGap())
        );
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(medicalLeadComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        if ("".equals(patientNumberTextField.getText())
            ...
            Object[] obj = {"OK"};
            JOptionPane.showOptionDialog(this, "One or more fields with patient data are empty.",
                    "Error",
        ...
        if (surgeryComboBox.getSelectedIndex() == -1
            ...
            Object[] obj = {"OK"};
            JOptionPane.showOptionDialog(this, "One or more fields with medical data are empty.",
                    "Error",
                    JOptionPane.OK_OPTION,
                    JOptionPane.ERROR_MESSAGE,
                    null, obj, JOptionPane.OK_OPTION);
...
//            SeePatientListPanel_EN.updatePatientListTable(-1, false);
            ...
            Object[] obj = {"OK"};
            JOptionPane.showOptionDialog(this, "Patient and/or surgery added.",
                    "Info",
                    JOptionPane.OK_OPTION,
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        if (patient == null) {
            Object[] obj = {"OK"};
            JOptionPane.showOptionDialog(this, "There is no patient with this ID. "
                    + "Choose the option to add surgery for this (new) patient.",
                    "Invalid ID",
                    JOptionPane.OK_OPTION,
                    JOptionPane.INFORMATION_MESSAGE,
                    null, obj, JOptionPane.OK_OPTION);
        ...
        if (surgeryComboBox.getSelectedIndex() < 0) {
            Object[] obj = {"OK"};
            JOptionPane.showOptionDialog(this, "A surgery needs to be selected.",
                    "Surgery error",
                    JOptionPane.OK_OPTION,
                    JOptionPane.ERROR_MESSAGE,
                    null, obj, JOptionPane.OK_OPTION);
        ...
        if (scheduledCheckBox.isSelected() && datePicker.getDate() == null) {
            Object[] obj = {"OK"};
            JOptionPane.showOptionDialog(this, "A date needs to be selected.",
                    "Date error",
                    JOptionPane.OK_OPTION,
                    JOptionPane.ERROR_MESSAGE,
                    null, obj, JOptionPane.OK_OPTION);
        ...
        int opt = JOptionPane.showOptionDialog(this, "Are you sure you want to update the surgery information?",
                "Medical data update",
    ...
    private void deleteSurgeryButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteSurgeryButtonActionPerformed
        ...
        int opt = JOptionPane.showOptionDialog(null, "Are you sure you want to delete this surgery?",
                "Warning! Surgery removal",
                JOptionPane.YES_NO_OPTION,
                JOptionPane.INFORMATION_MESSAGE, null, null, JOptionPane.NO_OPTION);
    ...
    private void savePatientInfoButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savePatientInfoButtonActionPerformed
        if ("".equals(patientNumberTextField.getText())
                ...
                || "".equals(birthYearFormattedTextField.getText())) {
            Object[] obj = {"OK"};
            JOptionPane.showOptionDialog(null, "One or more fields are empty.",
                    "Error",
                    JOptionPane.OK_OPTION,
                    JOptionPane.ERROR_MESSAGE,
                    null, obj, JOptionPane.OK_OPTION);
...
//        SeePatientListPanel_EN.updatePatientListTable(-1, false);
        ...
        Object[] obj = {"OK"};
        JOptionPane.showOptionDialog(this, "Patient's info are saved.",
                "Info",
                JOptionPane.OK_OPTION,
                JOptionPane.INFORMATION_MESSAGE,
                null, obj, JOptionPane.OK_OPTION);
    ...
    public void updateSecondHalfInterface() {
        surgeryComboBox.removeAllItems();
        pathologyComboBox.removeAllItems();
        medicalLeadComboBox.removeAllItems();
        medicsComboBox.removeAllItems();
    ...
    private static javax.swing.ButtonGroup addUpdateButtonGroup;
