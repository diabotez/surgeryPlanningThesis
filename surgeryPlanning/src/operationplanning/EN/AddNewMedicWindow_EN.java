 ...
 */
public class AddNewMedicWindow_EN extends javax.swing.JFrame {

    /**
     * Creates new form AddNewMedicWindow
     */
    public AddNewMedicWindow_EN() {
        initComponents();
    ...
    private void initComponents() {
        ...
        AddNewTeamButton.setText("Add new doctor");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(memberLastNameTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 565, Short.MAX_VALUE)
                    .addComponent(memberFirstNameTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 565, Short.MAX_VALUE)
                    .addComponent(memberDepartmentTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 565, Short.MAX_VALUE)
    ...
    private void AddNewTeamButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddNewTeamButtonActionPerformed
        ...
        if ("".equals(memberLastName) || "".equals(memberDepartment)
            ...
            JOptionPane.showMessageDialog(this, "One or more fields are empty. Fill them and try again.",
                    "Error adding a new medic", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (-1 != medicalInst.getTeamIndexWithThisCoordinator(member)) {
            JOptionPane.showMessageDialog(this, "This member already exists as a coordinator. He cannot be in another team.",
                    "Error - Member name", JOptionPane.ERROR_MESSAGE);
            return;
        } else if (medicalInst.existsTeamWithThisMember(member)) {
            JOptionPane.showMessageDialog(this, "This member name already exists in a team. He cannot be in another team.",
                    "Error - Member name", JOptionPane.ERROR_MESSAGE);
            return;
        }

        Object[] o = {"Add", "Cancel"};
        int option = JOptionPane.showOptionDialog(this, "You are about to add a new medic with the following data:\n"
                + "\nmedic's last name - " + memberLastName
                + "\nmedic's first name - " + memberFirstName
                + "\nmedic's department - " + memberDepartment
                + "\n\nInto " + coordinator.lastName + " " + coordinator.firstName + "'s team."
                + "\n\nAre you sure you want to add this new medic?",
                "Adding a new medic", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE, null, o, o[1]);
