 ...
 */
public class UpdateRemoveSurgeryWindow_ES extends javax.swing.JFrame {
     ...
     */
    public UpdateRemoveSurgeryWindow_ES() {
        initComponents();
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        if (surgeryComboBox.getSelectedItem() == null) {
            JOptionPane.showMessageDialog(this, "¡No hay cirugía para actualizar!\n",
                    "Error",
        ...
        if (option == 0) {
            //update the data
            SurgeriesListPanel_ES.updateSurgeryEntry(srg, ptg, avg, std);
            this.dispose();
        }
    ...
    private void removeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
        ...
        Object[] o = {"Borrar", "Cancelar"};

        int option = JOptionPane.showOptionDialog(this, "Estás a punto de eliminar los siguientes datos:\n"
                + srg
                + "\n\n ¿Está seguro de que desea eliminar estos datos permanentemente de la base de datos?",
                "¡Advertencia! Eliminación de datos",
                JOptionPane.OK_CANCEL_OPTION,
                JOptionPane.WARNING_MESSAGE, null, o, o[1]);

        if (option == 0) {
            //remove data
            if (!SurgeriesListPanel_ES.removeSurgeryEntry(srg)) {
                JOptionPane.showConfirmDialog(null,
                        "No se pudo eliminar la cirugía. \n"
                        + "Puede haber pacientes que están programados o necesitan \n"
                        + "ser programados para esta cirugía.",
                        "Error al eliminar la cirugía",
