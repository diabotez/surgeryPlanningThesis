 ...
 * @author diana
 */
public class CreateUserPanel_ES extends javax.swing.JPanel {

    /**
     * Creates new form UserPanel_EN
     * @param userType
     */
    public CreateUserPanel_ES() {
    ...
    private void initComponents() {
        ...
        newPasswordLabel.setText("Contraseña");
        ...
        userTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Jefe del Departamento", "Coordinador", "Médico", "Asistente" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(repeatPasswordField, javax.swing.GroupLayout.DEFAULT_SIZE, 385, Short.MAX_VALUE)
                            .addComponent(newPasswordField)
                            .addComponent(userNameTextField)
                            .addComponent(userTypeComboBox, 0, 385, Short.MAX_VALUE))
                        .addGap(240, 240, 240))))
        );
    ...
    private void createUserButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserButtonActionPerformed
        ...
        if("".equals(userNameTextField.getText()) || "".equals(newPassword) || "".equals(repeatPassword)){
            JOptionPane.showConfirmDialog(null, "Uno o más campos están vacíos."
                    + "\nAgregar nuevo usuario anulado.", "Error. Campos vacíos", JOptionPane.DEFAULT_OPTION);
            return;
        }

        if (!newPassword.equals(repeatPassword)) {
            JOptionPane.showConfirmDialog(null, "La contraseña no es la misma en ambos campos."
                    + "\nAgregar nuevo usuario anulado.", "La contraseña no coincide", JOptionPane.DEFAULT_OPTION);
            return;
        }
        int ans = JOptionPane.showOptionDialog(null, new JLabel("<html>¿Seguro que quieres agregar \n"
                + "este usuario <b>" + userNameTextField.getText() + "</b>?</html>"),
                "Confirmación de agregar nuevo usuario",
        ...
        if (ans == JOptionPane.OK_OPTION) {
            ...
            if (addUser) {
                JOptionPane.showConfirmDialog(null, "El usuario se ha agregado correctamente.",
                ...
                JOptionPane.showConfirmDialog(null, "El usuario NO ha sido agregado. Puede que ya exista en la base de datos.",
