 ...
 * @author diana
 */
public class SetSurgeryCompleted_ES extends javax.swing.JPanel {
     ...
     */
    public SetSurgeryCompleted_ES() {
        patientDetailsTableModel_EN = new MyUneditableTableModel(
                new String[]{"Id de paciente", "Nombre", "Apellido", "Cirugía", 
                    "Patología", "Nombre del médico", "Nombre del equipo", 
                    "Sala de operaciones", "Fecha de admisión", "Fecha programada", "Terminado" },
                0) //<editor-fold defaultstate="collapsed" desc="set column classes">
        {
            ...
            public Class getColumnClass(int col) {
                ...
                if (name.equals("Fecha de admisión") || name.equals("Fecha programada")) {
                    return Date.class;
                } else {
    ...
    private void initComponents() {
        ...
        setCompletedButton.setText("Definir como terminado");
    ...
    private void setCompletedButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setCompletedButtonActionPerformed
        ...
        if (-1 == row) {
            JOptionPane.showConfirmDialog(null,
                    ...
                    "Paciente y cirugía desconocido",
        ...
        for (int i = 0; i < patientDetailsTableModel_EN.getColumnCount(); i++) {
            if ("Id de paciente".equals(patientDetailsTableModel_EN.getColumnName(i))) {
                columnID = i;
                break;
            }
        }
        for (int i = 0; i < patientDetailsTableModel_EN.getColumnCount(); i++) {
            if ("Cirugía".equals(patientDetailsTableModel_EN.getColumnName(i))) {
                columnSurgery = i;
                break;
            }
        }
        try {
            ...
            int ans = JOptionPane.showOptionDialog(null, new JLabel(
                    "<html>¿Desea establecer la cirugía <br><b>"
                    + srgName
                    + "</b> para el paciente <b>"
                    + patientID + " como terminado? </b> ?"),
                    "Confirmación",
